...
\uppertitleback{%
    ...
    \theBarbara, \quad schwanger%
		\quad  (\ref{scene:I}, \ref{scene:IV}, \ref{scene:VI})\\
	\theJosef, \quad ihr Mann,%
		\quad  (\ref{scene:I}, \ref{scene:IV}, \ref{scene:VI})\\
    \theKathrine, \quad blind%
		\quad  (\ref{scene:I}, \ref{scene:IV})\\
    \theGregor%
		\quad  (\ref{scene:I}, \ref{scene:VI})\\
    \theJan\\
    \theAndreas\\
    \theLuise%
		\quad  (\ref{scene:I}, \ref{scene:VI})\\
    ...
    Paul, der \theGeneraldirektor der Chemiefrabrik%
		\quad  (\ref{scene:II}, \ref{scene:IV}, \ref{scene:V}, \ref{scene:VI})\\
    \theClarisse, \quad seine Frau%
		\quad  (\ref{scene:II}, \ref{scene:V}, \ref{scene:VI})\\
    \theAlexis, \quad Ingenieur%
		\quad  (\ref{scene:II}, \ref{scene:IV}, \ref{scene:V}, \ref{scene:VI})\\
    Doktor \theThomsen, \quad Arzt%
		\quad  (\ref{scene:I}, \ref{scene:II}, \ref{scene:V})\\
	Doktor \theJonas, \quad Arzt%
		\quad  (\ref{scene:II}, \ref{scene:V}, \ref{scene:IV})\\
    \theSalwin, \quad Pressekorrespondent%
		\quad  (\ref{scene:II}, \ref{scene:VI})\\
    \theBrix, \quad Militär, Chemiker%
		\quad  (\ref{scene:VI})\\
    Jakob \theMelchior, \quad ehem. Militär, sein Vertrauter%
		\quad  (\ref{scene:IV}, \ref{scene:V}, \ref{scene:VI})\\
    \theHeilsarmeeschwester%
		\quad  (\ref{scene:III}, \ref{scene:IV}, \ref{scene:IV})\\
    \theErsterMann%
		\quad  (\ref{scene:III}, \ref{scene:VI})\\
    \theZweiterMann%
		\quad  (\ref{scene:III}, \ref{scene:VI})\\
    \theSergeant\\
    \theDiener\\
